...
-- ----------------------------
-- Table structure for web_agent_achievement
-- ----------------------------
DROP TABLE IF EXISTS `web_agent_achievement`;
 CREATE TABLE `web_agent_achievement` (
  `id` bigint(16) NOT NULL AUTO_INCREMENT,
  `money_change_id` int(11) DEFAULT NULL COMMENT '金币变化id',
  `change_user_id` int(11) DEFAULT NULL COMMENT '金币变化游戏id',
  `money_change` bigint(18) DEFAULT NULL COMMENT '金币变化数量',
  `rate_money` int(11) DEFAULT '0' COMMENT '抽水金币',
  `per_centum` int(11) DEFAULT NULL COMMENT '比例',
  `user_id` int(11) DEFAULT NULL COMMENT '游戏id',
  `leve` int(1) DEFAULT NULL COMMENT '返佣等级',
  `achievement_money` decimal(18,2) DEFAULT '0.00' COMMENT '返佣业绩',
  `time` int(11) DEFAULT NULL,
  `front_achievement_money` decimal(18,2) DEFAULT '0.00' COMMENT '返佣前业绩',
  `after_achievement_money` decimal(18,2) DEFAULT '0.00' COMMENT '返佣后业绩',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `time` (`time`),
  KEY `change_user_id` (`change_user_id`),
  KEY `money_change_id` (`money_change_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Table structure for web_agent_achievement_confing
-- ----------------------------
DROP TABLE IF EXISTS `web_agent_achievement_confing`;
CREATE TABLE `web_agent_achievement_confing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `achievement` bigint(18) DEFAULT NULL,
  `value` int(11) DEFAULT NULL,
  `per_centum` int(11) DEFAULT NULL,
  `name` varchar(64) DEFAULT NULL COMMENT '代理等级',
  PRIMARY KEY (`id`)
...
CREATE TABLE `web_agent_apply_pos` (
  ...
  `rel_name` varchar(50) DEFAULT NULL COMMENT '开户行姓名',
  ...
  `type` tinyint(1) DEFAULT NULL COMMENT '提现类型 1金币提现 2佣金提现',
  `front_money` int(11) DEFAULT '0' COMMENT '申请前玩家金币数量',
  `after_money` int(11) DEFAULT '0' COMMENT '申请后玩家金币数量',
  `order` varchar(64) DEFAULT NULL COMMENT '订单号',
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  KEY `agentid` (`agentid`),
  KEY `username` (`username`),
  KEY `apply_time` (`apply_time`)
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 COMMENT='代理提现记录';
...
-- ----------------------------
-- Table structure for web_agent_bill
-- ----------------------------
DROP TABLE IF EXISTS `web_agent_bill`;
CREATE TABLE `web_agent_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userid` int(11) DEFAULT NULL,
  `front_money` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '变化前佣金',
  `rmb` decimal(18,2) NOT NULL,
  `time` int(11) DEFAULT NULL,
  `after_money` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '变化后佣金',
  `week_money` decimal(18,2) DEFAULT NULL COMMENT '本周业绩',
  `under_achievement` decimal(18,2) NOT NULL COMMENT '直属业绩',
  `not_under_achievement` decimal(18,2) NOT NULL COMMENT '非直属业绩',
  `proportion` int(10) NOT NULL DEFAULT '0' COMMENT '每万返金币数量',
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`),
  KEY `time` (`time`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
-- Table structure for web_agent_extractable
-- ----------------------------
DROP TABLE IF EXISTS `web_agent_extractable`;
CREATE TABLE `web_agent_extractable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `balance_change` decimal(14,2) DEFAULT NULL COMMENT '变化数量',
  `front_balance` decimal(14,2) DEFAULT NULL COMMENT '变化前',
  `after_balance` decimal(14,2) DEFAULT NULL COMMENT '变化后',
  `time` int(11) DEFAULT NULL,
  `withholding_money` decimal(14,2) DEFAULT NULL,
  `to_be_extracted_money` decimal(14,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `time` (`time`)
) ENGINE=InnoDB AUTO_INCREMENT=64033 DEFAULT CHARSET=utf8 COMMENT='可提现金币变化表';
...
CREATE TABLE `web_agent_member` (
  ...
  `wechat` varchar(30) DEFAULT NULL COMMENT '微信号',
  `bankcard` varchar(50) DEFAULT NULL COMMENT '银行卡',
  `balance` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '可提现佣金',
  `disabled` int(11) DEFAULT NULL,
  `under_money` decimal(18,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '直属佣金',
  `not_under_money` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '非直属佣金',
  `email` varchar(50) DEFAULT NULL,
  `history_pos_money` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '已提现金额',
  `status` int(11) DEFAULT NULL,
  `wx_token` varchar(100) DEFAULT NULL,
  `rel_name` varchar(100) DEFAULT NULL COMMENT '持卡人姓名',
  `media_id` varchar(150) DEFAULT NULL,
  `total_achievement` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '总业绩',
  `under_achievement` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '直属业绩',
  `not_under_achievement` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '非直属业绩',
  `week_money` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '本周业绩',
  `to_be_extracted_money` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '待提现金币 ',
  `code_url` varchar(255) DEFAULT NULL COMMENT '二维码地址',
  `bottom_guard` int(11) DEFAULT '0' COMMENT '业绩保底',
  `withholding_money` decimal(18,2) DEFAULT '0.00' COMMENT '预提佣金',
  `up_withholding_money` decimal(18,2) DEFAULT '0.00' COMMENT '上周预提',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1658 DEFAULT CHARSET=utf8 COMMENT='代理会员表';
...
-- ----------------------------
-- Table structure for web_agent_total_agent
-- ----------------------------
DROP TABLE IF EXISTS `web_agent_total_agent`;
CREATE TABLE `web_agent_total_agent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userID` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `web_api_record` (
  ...
  `params` varchar(1024) NOT NULL DEFAULT '' COMMENT '请求url关键参数',
...
-- ----------------------------
-- Table structure for web_packet_version_type
-- ----------------------------
...
-- Table structure for web_pay_goods
-- ----------------------------
DROP TABLE IF EXISTS `web_pay_goods_contact`;
CREATE TABLE `web_pay_goods_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wx` varchar(100) DEFAULT NULL COMMENT '微信',
  `qq` varchar(100) DEFAULT NULL COMMENT 'qq联系方式',
  `time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
-- Table structure for web_pay_apply_pos
-- ----------------------------
DROP TABLE IF EXISTS `web_pay_apply_pos`;
CREATE TABLE `web_pay_apply_pos` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(11) DEFAULT NULL COMMENT '名称',
  `userid` int(11) DEFAULT NULL COMMENT '游戏id',
  `bankcard` varchar(50) DEFAULT NULL COMMENT '银行卡',
  ...
  `type` tinyint(2) DEFAULT NULL COMMENT '1银行卡 2支付宝',
...
DROP TABLE IF EXISTS `web_user_head_img`;
CREATE TABLE `web_user_head_img` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
